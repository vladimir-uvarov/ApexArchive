        ...
        ScrollView(.horizontal) {
            HStack(spacing: DesignTokens.spacingMedium) {
                ...
                NavigationLink {
                    ...
                    activity(
                        title: String(localized: "places.title", defaultValue: "Places to visit"),
                        subtitle: String(
                            localized: "places.short",
                            defaultValue: "Museums, collections and the circuits themselves."),
            ...
            // Draw past the page padding like the driver filter and detail-section rails, so cards
            // scroll the full width of the screen instead of being clipped at the inset.
            .scrollClipDisabled()
    }
