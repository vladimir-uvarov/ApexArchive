...
enum DesignTokens {
    ...
    static let teamFlagSize: CGFloat = 44
    static let circuitLineWidth: CGFloat = 3
    /// Outline margin as a share of the smaller edge, so a small card is not mostly margin.
    static let circuitOutlineInsetFraction: CGFloat = 0.08
