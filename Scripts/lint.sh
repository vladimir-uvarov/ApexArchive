...
set -euo pipefail
cd "$(dirname "$0")/.."
xcrun swift-format lint --strict --recursive --configuration .swift-format ApexArchive ApexArchiveTests Packages/ArchiveKit/Sources Packages/ArchiveKit/Tests Packages/ArchiveKit/Tools
