...
paths = [*root.joinpath("ApexArchive").rglob("*.swift"), *root.joinpath("Packages/ArchiveKit/Sources").rglob("*.swift"), *root.joinpath("Packages/ArchiveKit/Tests").rglob("*.swift"), *root.joinpath("Packages/ArchiveKit/Tools").rglob("*.swift")]
